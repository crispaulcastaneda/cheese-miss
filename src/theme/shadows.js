...
const lightMode = palette.light.grey[500];
const darkMode = '#000000';

const createShadow = (clr) => {
    const transparent1 = alpha(clr, 0.2);
    const transparent2 = alpha(clr, 0.14);
    const transparent3 = alpha(clr, 0.12);
...
export const customShadows = {
  light: createCustomShadow(lightMode),
  dark: createCustomShadow(darkMode),
};

const shadows = {
  light: createShadow(lightMode),
  dark: createShadow(darkMode),
};
